...
public class currency extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SriLankan Rupees", "Indian Rupees", "Chinese Yuan", "Japanese Yen", "Saudi Riyal", "Brazilian Reais" }));
        ...
        jLabel4.setText("Currency Converter (June 2023)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(txtfrom.getSelectedItem().toString() == "USD" && txtto.getSelectedItem().toString() == "Japanese Yen")
        {
            tot = amount * 144.6;
            JOptionPane.showMessageDialog(this,"Your Amount will be " + tot.toString());
        }
        else if(txtfrom.getSelectedItem().toString() == "USD" && txtto.getSelectedItem().toString() == "Brazilian Reais")
        {
            tot = amount * 4.8;
            JOptionPane.showMessageDialog(this,"Your Amount will be " + tot.toString());
        }
